...
<div class="flex flex-col w-full gap-y-4">
    <div class="flex w-full items-center justify-between">
        <h1 class="font-semibold text-xl text-center">Registered Employees</h1>
        <div class="flex flex-row  gap-4">
            ...
            <a href="create_employee.php?page=createEmployee" class="bg-violet-800 hover:bg-violet-900 text-white gap-x-3 font-bold py-2 px-4 rounded">
    ...
    <div class="w-full flex overflow-x-auto">
        <table class="min-w-[500px]">
            ...
            <tbody>
            <c:forEach items="${employees}" var="usr" varStatus="usrstatus">
                <tr>
                    <td>${usr.id}</td>
                    <td>${usr.firstName}</td>
                    <td>${usr.lastName}</td>
                    ...
                    <td class="buttons flex space-x-4 justify-end">
                        <a href="update.php?id=${usr.id}&page=updateEmployee">
                            <button type="submit"><i class='bx bxs-edit text-2xl'></i></button>
                        </a>
                        <a href="delete.php?id=${usr.id}&page=deleteEmployee">
